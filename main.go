...
const (
	...
	layoutURLTemplate = "https://my.glove80.com/#/layout/user/%s"
	cacheFileName     = "g80-layouts-cache.json"
	cachePerms        = 0644
)

// Layout generated by the lovely tool: https://mholt.github.io/json-to-go/
type Layout struct {
	Metadata struct {
...
func (l Layout) URL() string {
	return fmt.Sprintf(layoutURLTemplate, l.Metadata.UUID)
}
...
func (l Layout) AsRow() []string {
	...
	return []string{date, l.Metadata.Title, l.Metadata.Notes, l.Metadata.Creator, l.URL()}
}
...
func main() {
	...
	table.SetHeader([]string{"Date", "Title", "Notes", "Author", "URL"})
